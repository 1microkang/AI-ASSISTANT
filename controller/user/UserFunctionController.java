...
//    @GetMapping(value = "ai_intelligent", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
//    @ApiOperation("推荐图书")
//    public Flux<String> aiRecommend(@RequestParam String message) {
//        log.info("收到请求：{}", message);
//
//        return aiIntelligentService.streamChat(message)
//                .map(content ->
//                        // ✅ 正确格式：data:{"data":"具体内容"}\n\n
//                        JSON.toJSONString(
//                                Collections.singletonMap("data", content)
//                        ) + "\n\n"
//                )
//                .onErrorResume(e ->
//                        Flux.just(JSON.toJSONString(
...
//    }
    @PostMapping("ai_intelligent")
    @ApiOperation("推荐图书")
    public Flux<String> aiRecommend(@RequestBody AiMsg aiMsg) {
        String message = aiMsg.getMessage();
        log.info("收到请求：{}", message);
