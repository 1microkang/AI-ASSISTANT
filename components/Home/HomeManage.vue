  ...
  <el-container class="home-container">
    ...
    <el-header>
      <div>
        ...
        <span style="color: #ccc; font-size: 16px">Librarian Page</span>
      </div>
      <div>
        <a href="https://github.com/luoye6/Vue_BookManageSystem" title="GitHub Source Code" target="_blank"
        ...
        <a href="https://gitee.com/falle22222n-leaves/vue_-book-manage-system" title="Gitee Source Code"
          target="_blank">
        ...
        <div class="user">Admin:{{ this.bookAdmin.bookAdminName }}</div>
      ...
      <el-aside :width="isCollapse ? '64px' : '200px'">
        ...
        <el-menu :default-active="activePath" class="el-menu-vertical-demo" background-color="#fff" text-color="black"
          ...
          <el-menu-item index="borrowbook" @click="saveNavState('borrowbook')">
            ...
            <span slo="title">Borrow Books</span>
          </el-menu-item>
