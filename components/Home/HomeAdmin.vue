  ...
  <el-container class="home-container">
    ...
    <el-header>
      <div>
        ...
        <span>Welcome</span>
        <span style="color: #ccc; font-size: 16px">System Administrator Page</span>
      </div>
      <div>
        <a href="https://github.com/luoye6/Vue_BookManageSystem" title="GitHub Source Code Address" target="_blank"
        ...
        <a href="https://gitee.com/falle22222n-leaves/vue_-book-manage-system" title="Gitee Source Code Address"
          target="_blank">
        ...
        <div class="user">Admin:{{ this.admin.adminName }}</div>
