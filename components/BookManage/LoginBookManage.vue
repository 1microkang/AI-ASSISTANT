<template>
  <div class="login_container">
    <div class="login_title">Librarian Login Page</div>
    <div class="login_box">
      <!-- Avatar Area -->
      ...
      <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="login_form">
        ...
        <el-form-item class="btns">
          <el-button type="primary" @click="login" :loading="loginLoading">Login
          </el-button>
  ...
  methods: {
    ...
    login() {
      this.$refs.loginFormRef.validate(async (valid) => {
        ...
        //Send axios request to database, if login succeeds, redirect
