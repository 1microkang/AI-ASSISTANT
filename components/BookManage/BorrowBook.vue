  ...
  <div class="borrowbook_container">
    ...
    <div class="banner">
      <div class="card_number">
        <el-input placeholder="Enter library card number" v-model.number="borrowInfo.cardNumber">
          <el-button slot="prepend" icon="el-icon-notebook-2"></el-button>
        </el-input>
      </div>
      <div class="book_number">
        <el-input placeholder="Enter book number" v-model.number="borrowInfo.bookNumber">
          <el-button slot="prepend" icon="el-icon-collection"></el-button></el-input>
      </div>
      <div class="borrow_date">
        <el-date-picker v-model="borrowInfo.borrowDate" type="datetime" placeholder="Select date and time"
    ...
    async borrowBook() {
      ...
      if (this.borrowInfo.borrowDate === "") {
        return this.$message.error({
          message: "Borrow time cannot be empty",
          duration: 1000
        })
      }
