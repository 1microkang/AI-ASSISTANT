<template>
  <div class="search_container">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>Book Return Report</el-breadcrumb-item>
    </el-breadcrumb>
      ...
      <el-row>
        ...
        <el-col :span="4">
          <el-input placeholder="Please enter" v-model="queryInfo.query" class="input-with-select"
            @keyup.enter.native="getReturnStatement">
            <el-button slot="append" icon="el-icon-search" @click="getReturnStatement"></el-button> </el-input></el-col>
        <el-col :span="2" style="float: right">
          <download-excel class="export-excel-wrapper" :data="tableData" :fields="json_fields" :header="title"
            name="Book_Return_Report.xls">
