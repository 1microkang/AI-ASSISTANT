  ...
  <div class="search_container">
    ...
    <el-card shadow="always">
      ...
      <el-table :data="tableData" border style="width: 100%" stripe id="pdfDom"
        :default-sort="{ prop: 'violationId', order: 'ascending' }" v-loading="loading" element-loading-text="拼命加载中"
        ...
        <el-table-column prop="violationMessage" label="Violation Info"> </el-table-column>
        <el-table-column prop="violationAdmin" label="Processed By"> </el-table-column>
      </el-table>
      <!-- Pagination Area -->
