<template>
  <div class="notice_container">
    ...
    <div class="banner">
      ...
      <div class="banner_main" v-loading="loading" element-loading-text="Loading..."
...
export default {
  data() {
    return {
      text: "Library Notice Board, please check for updates! Small project, please don't attack maliciously, thank you",
      noticeList: [
        {
          noticeId: 0,
